...
public class ScheduleController {
    ...
    public HttpEntity<ResponseToEditScheduleDto> controllerToEditSchedule(@RequestBody RequestToEditScheduleDto
                                                                                  body, @PathVariable("scheduleId") Long scheduleId) throws IOException {
    ...
    public HttpEntity<ResponseToSearchScheduleListDto> controllerToSearchScheduleListByDate(
            @RequestParam(value = "endDate", defaultValue = "9999-01-01") String
                    endDate, @RequestParam(value = "startDate", defaultValue = "1000-01-01") String startDate,
            @PathVariable(value = "userId") Long userId, @RequestParam(value = "schedulePage") Long
                    schedulePage, @RequestParam(value = "pageSize") Long pageSize
    ) throws IOException {

        ResponseToSearchScheduleListDto response = scheduleService.searchToDatabaseByDate(new RequestToSearchScheduleByDateDto(startDate, endDate, userId, schedulePage, pageSize));
    ...
    public HttpEntity<ResponseToViewScheduleDto> controllerToViewSchedule(@PathVariable("scheduleId") Long
                                                                                  scheduleId) throws IOException {
        ResponseToViewScheduleDto response = scheduleService.viewToDatabase(new RequestToViewScheduleDto(scheduleId));
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public HttpEntity<ResponseToDeleteScheduleDto> controllerToDelete(@PathVariable("scheduleId") Long
                                                                              scheduleId, @RequestBody RequestToDeleteScheduleDto body) throws IOException {
